$(document).ready(function () {
    ...
    //поиск совпадений
    function ifincludes(text, pattern) {
    ...
    function renderSuggestions() {
        ...
        if (ifincludes($('.NB_search_help').html(), ('(док)'))) {
            $('.NB_search_help').prepend('<a class="NB_search_help_item NB_grenable Fmenu" href="/citystaff/docs_base/index.php?item=' + $searchInput.val() + '&type=doc">Документы: ' + $searchInput.val() + '...</a>');
        }
        if (ifincludes($('.NB_search_help').html(), ('(шаб)'))) {
            $('.NB_search_help').prepend('<a class="NB_search_help_item NB_grenable Fmenu" href="/citystaff/docs_base/index.php?item=' + $searchInput.val() + '&type=temp">Шаблоны: ' + $searchInput.val() + '...</a>');
        }
    }
