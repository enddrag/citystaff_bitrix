...
<div class="NB2_bonusInfo_right_item">
	<?if((!isset($arParams["DISPLAY_PICTURE"]) || $arParams["DISPLAY_PICTURE"]!="N") && is_array($arResult["DETAIL_PICTURE"])):?>
        <img src="<?=$arResult["DETAIL_PICTURE"]["SRC"]?>" alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>" class="NB2_bonusInfo_right_item_ico">
	<?endif?>
    ...
    ?>
        <a href="<?=$item[3]?>" class="Fmenu NB2_gradient_button d-flex flex-row align-items-center justify-content-center"><?=$item[2]?></a>
    ...
    <div class="NB2_bonusInfo_right_item">
        ...
        <img src="<?=$arResult["PREVIEW_PICTURE"]["SRC"]?>" alt="<?=$arResult["PREVIEW_PICTURE"]["ALT"]?>" class="NB2_bonusInfo_right_item_img">
	    <?endif?>
    </div>