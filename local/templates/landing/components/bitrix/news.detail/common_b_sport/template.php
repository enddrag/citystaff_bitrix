...
<section class="widthBase NB_content NB2_sport d-flex flex-row justify-content-between">
    <div class="NB2_sport_left d-flex flex-column justify-content-center">
        ...
        <div class="NB2_sport_left_links d-flex flex-row justify-content-between">
            <a href="<?=$item[1]?>" class="Fmenu NB2_gradient_button d-flex flex-row align-items-center justify-content-center"><?=$item[0]?></a>
    ...
    <?if((!isset($arParams["DISPLAY_PICTURE"]) || $arParams["DISPLAY_PICTURE"]!="N") && is_array($arResult["DETAIL_PICTURE"])):?>
        <img src="<?=$arResult["DETAIL_PICTURE"]["SRC"]?>" alt="<?=$arResult["DETAIL_PICTURE"]["ALT"]?>" class="NB2_sport_right NB_rounded-20">
    <?endif?>
</section>