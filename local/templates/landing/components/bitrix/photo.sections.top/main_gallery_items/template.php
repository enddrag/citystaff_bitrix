...
<?php foreach($arResult["SECTIONS"] as $arSection):?>
	...
	if($arSection['CODE'] == "NOTGALLERY") continue;
?>
	<div class="d-flex flex-row align-items-center justify-content-center NB_content_tradition_menu_item NB_rounded-30 Fbody text-white NB_backdrop-blur" id="<?=$arSection['CODE']?> <?=$this->GetEditAreaId('section_'.$arSection['ID']);?>"><?=$arSection["NAME"]?></div>
	<?php endif;?>
<?php endforeach;?>
</div>
