...
if($arSection = $selectSection->GetNext()) if($arSection['NAME'] !== "белые элементы") continue;
    $link = '';
    $name = '';
	?>
    <div class="NB2_bonusInfo_left_item_white NB_rounded-20 d-flex flex-column justify-content-between" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
        <div class="d-flex flex-column">
            ...
            <?if(($arItem["DETAIL_TEXT"] ?? '') !== ''):?>
                <p class="Fbody"><?print_r($arItem["DETAIL_TEXT"]);?></p>
            <?endif;?>
        </div>
        <?php
            ...
            foreach($arItem['PROPERTIES'] as $arProp){
                ...
                else if($arProp['NAME']=='link_href') $link = $arProp['VALUE'];
            }
        ?>
