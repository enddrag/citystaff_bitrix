...
<?foreach($arResult["ITEMS"] as $arItem):?>
    ...
    if($arSection = $selectSection->GetNext()) if($arSection['NAME'] != "вопросник") continue;
    ?>
    <div class="NB3_q_item d-flex flex-column align-items-center justify-content-between NB_rounded-20" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
