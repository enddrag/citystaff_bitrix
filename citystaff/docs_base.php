...
?><!--навигационное меню сайта--> <nav class="NB_menu NB1_menu_color widthBase navbar navbar-expand-lg d-flex flex-row justify-content-around">
<div class="NB_left d-flex flex-row justify-content-around align-items-center">
...
);?> <!--Основное содержимое меню--> <?$APPLICATION->IncludeComponent(
	"bitrix:news.list",
	...
	Array(
		...
		"PROPERTY_CODE" => array(0=>"sug_link",1=>"sug_name",2=>"",),
		"SET_BROWSER_TITLE" => "Y",
		"SET_LAST_MODIFIED" => "N",
...
);?> <!--пункты навигации--> <?$APPLICATION->IncludeComponent(
	"bitrix:menu",
	"common_header_menu",
	Array(
...
<!--баннер--> <section class="NB1_banner d-flex flex-row widthBase">
<div class="NB1_banner_left d-flex flex-row justify-content-between align-items-center">
	...
	Array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => "/local/templates/landing/includes/common_docs_banner_item1"
	)
);?> <?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	"",
	Array(
		...
		"AREA_FILE_SUFFIX" => "inc",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/local/templates/landing/includes/common_docs_item_img"
	)
);?>
</div>
<div class="NB1_banner_right d-flex flex-column align-items-center justify-content-center">
	...
	Array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => "/local/templates/landing/includes/common_docs_banner_item2"
	)
);?> <?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	"main_about_p",
	Array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => "/local/templates/landing/includes/common_docs_banner_item3"
	)
);?>
</div>
 </section>
<!--общее--> <section class="NB1_section_info NB_content widthBase d-flex flex-column">
<?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	"main_union_title",
	Array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => "/local/templates/landing/includes/common_info_title1"
	)
);?> <?$APPLICATION->IncludeComponent(
	"bitrix:news.list",
	"common_docs_info",
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array(0=>"link_name",1=>"link_href",),
		"SET_BROWSER_TITLE" => "Y",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "Y",
		"SET_META_KEYWORDS" => "Y",
...
<!--документы--> <section class="NB1_docs d-flex flex-column NB_content widthBase">
<?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	"main_union_title",
	Array(
...
<div class="NB_search NB1_docs_item_size NB1_search_color NB_backdrop-blur NB_rounded-30 search-box d-flex me-3 align-items-center justify-content-around">
 <input type="search" placeholder="Найти" class="NB_search_input form-control Fmenu" id="search_documents">
	<div class="NB_search_ico NB1_search_ico_color NB_rounded-circle" style="background-image: url('img/search_green.png');" id="search_documents_ico">
	</div>
</div>
...
<h4 class="NB1_docs_items_empty" id="nodocuments">
-----------документов нет----------- </h4>
 </section>
<!--баннер шаблонов--> <section class="NB1_bannerT d-flex flex-row justify-content-between NB_content widthBase">
<div class="NB1_bannerT_content d-flex flex-column justify-content-center">
	...
	Array(
		...
		"COMPONENT_TEMPLATE" => "main_community_item_title3",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/local/templates/landing/includes/common_docs_banner_item4"
	)
);?> <?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	"main_about_p",
	Array(
		...
		"COMPONENT_TEMPLATE" => "main_about_p",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/local/templates/landing/includes/common_docs_banner_item5"
	)
);?>
</div>
 <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"AREA_FILE_SUFFIX" => "inc",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/local/templates/landing/includes/common_docs_banner_item6"
	)
);?> </section>
<!--шаблоны--> <section class="NB1_temp d-flex flex-row justify-content-between NB_content widthBase">
<div class="NB1_temp_item d-flex flex-row justify-content-between">
 ...
 <a href="#" class="Fa NB1_docs_item_right_look d-flex flex-row align-items-center">смотреть</a> <a href="#" class="NB1_docs_item_right_download d-flex" style="background-image: url('img/download.svg');"></a>
		...
		<?$APPLICATION->IncludeComponent("bitrix:news.detail", "common_link_hr", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"ELEMENT_CODE" => "common_link_hr",	// Код новости
 ...
 </section> <section class="widthBase NB_content NB_bottomMenu d-flex flex-row flex-wrap align-items-center">
<?$APPLICATION->IncludeComponent(
	"bitrix:news.detail",
...
<?php
    $APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH . '/assets/js/docsBase.js');
?><?php
