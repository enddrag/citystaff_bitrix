...
?>
            ...
            <div class="NB2_banner_info_item_left d-flex justify-content-center align-items-start flex-column">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    [
                        ...
                        'DISPLAY_PREVIEW_TEXT' => 'Y',
                        'DISPLAY_TOP_PAGER' => 'N',
                        'ELEMENT_CODE' => 'common_b_banner_item1',
                        'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                        'FIELD_CODE' => [
                            0 => '',
                            1 => '',
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    [
                        ...
                        'DISPLAY_PREVIEW_TEXT' => 'Y',
                        'DISPLAY_TOP_PAGER' => 'N',
                        'ELEMENT_CODE' => 'common_b_banner_item2',
                        'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                        'FIELD_CODE' => [
                            0 => '',
                            1 => '',
            ...
            <div class="NB2_banner_info_item_right d-flex flex-row justify-content-center align-items-center">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    [
                        ...
                        'DISPLAY_PREVIEW_TEXT' => 'Y',
                        'DISPLAY_TOP_PAGER' => 'N',
                        'ELEMENT_CODE' => 'common_b_banner_item3',
                        'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                        'FIELD_CODE' => [
                            0 => '',
                            1 => '',
            ...
            <div class="NB2_bonusInfo_left_item d-flex flex-row justify-content-between">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    [
                        ...
                        'PARENT_SECTION' => '',
                        // ID раздела
                        'PARENT_SECTION_CODE' => 'bonus_white',
                        // Код раздела
                        'PREVIEW_TRUNCATE_LEN' => '',
                        // Максимальная длина анонса для вывода (только для типа текст)
                        'PROPERTY_CODE' => [    // Свойства
    ...
    <section class="NB_modal d-flex flex-row align-items-center justify-content-center"
        ...
        <div class="NB_modal_item d-flex flex-column align-items-center">
            ...
            <div class="NB_modal_item_item flex-column align-items-center" id="survey" style="display: flex">
                ...
                $APPLICATION->IncludeComponent(
                        ...
                        [
                                ...
                                'DISPLAY_PREVIEW_TEXT' => 'Y',
                                'DISPLAY_TOP_PAGER' => 'N',
                                'ELEMENT_CODE' => 'common_bonus_form',
                                'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                                'FIELD_CODE' => [
                                        0 => '',
                                        1 => '',
            ...
            <div class="NB_modal_item_item flex-column align-items-center" id="sadMonkey" style="display: none">
                <h4>Заявка не принята:(</h4>
                <p class="Fbody NB_modal_item_p">Что то пошло не так... <br>Попробуйте позже...</p>
                <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/sadmonkey.png" alt="" class="NB_modal_monkey">
            </div>
        </div>
    </section>
    <!--стаффлики-->
    <section data-nav-title="Как заработать стаффлики?" id="staffcoinList"
        ...
        $APPLICATION->IncludeComponent(
            ...
            [
                ...
                'PAGER_TITLE' => 'Новости',
                'PARENT_SECTION' => '',
                'PARENT_SECTION_CODE' => 'staffDeserving',
                'PREVIEW_TRUNCATE_LEN' => '',
                'PROPERTY_CODE' => [
                    0 => '',
                    1 => 'link_name',
    ...
    <section class="widthBase NB_content NB_bottomMenu d-flex flex-row flex-wrap align-items-center">
        ...
        $APPLICATION->IncludeComponent(
            ...
            [
                ...
                'DISPLAY_PREVIEW_TEXT' => 'Y',
                'DISPLAY_TOP_PAGER' => 'N',
                'ELEMENT_CODE' => 'bonus_bottommenu_1',
                'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                'FIELD_CODE' => [
                    0 => '',
                    1 => '',
        ...
        $APPLICATION->IncludeComponent(
            ...
            [
                ...
                'DISPLAY_PREVIEW_TEXT' => 'Y',
                'DISPLAY_TOP_PAGER' => 'N',
                'ELEMENT_CODE' => 'bonus_bottommenu_2',
                'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                'FIELD_CODE' => [
                    0 => '',
                    1 => '',
