            ...
            <div class="NB2_banner_info_item_right d-flex flex-row justify-content-center align-items-center">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    [
                        ...
                        'AREA_FILE_SUFFIX' => 'inc',
                        'EDIT_TEMPLATE' => '',
                        'PATH' => '/local/templates/landing/includes/common_b_banner_item3.php',
                    ]
                ); ?>
            </div>
        </div>
    ...
    <section data-nav-title="Как заработать стаффлики?" id="staffcoinList"
        ...
        $APPLICATION->IncludeComponent(
            ...
            [
                ...
                'AREA_FILE_SUFFIX' => 'inc',
                'EDIT_TEMPLATE' => '',
                'PATH' => '/local/templates/landing/includes/common_b_p_p.php',
            ]
        ); ?>
        <?php
        $APPLICATION->IncludeComponent(
    ...
    <section data-nav-title="Поддержка здоровья" id="health" class="widthBase NB_content NB2_health d-flex flex-column">
        ...
        $APPLICATION->IncludeComponent(
            ...
            [
                ...
                'AREA_FILE_SUFFIX' => 'inc',
                'EDIT_TEMPLATE' => '',
                'PATH' => '/local/templates/landing/includes/common_b_h_p.php',
            ]
        ); ?>
        <?php
        $APPLICATION->IncludeComponent(
