...
?>
    ...
    <section data-nav-title="Ваше мнение важно" id="opinion" class="NB_banner d-flex flex-column align-items-center" style="background: linear-gradient(rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.37) 100%), url('/upload/medialibrary/428/6mrfhrzqrsxa4xowyueu5p7qutz4n2ju/faq.png'); background-size: cover; background-repeat: no-repeat; background-position-y: 20%">
        ...
        <div class="NB3_banner d-flex flex-row justify-content-between align-items-center">
            <div class="NB3_banner_content d-flex flex-column">
                <?php $APPLICATION->IncludeComponent("bitrix:main.include", "common_f_b_t", Array(
                    "AREA_FILE_SHOW" => "file",	// Показывать включаемую область
                    "AREA_FILE_SUFFIX" => "inc",
                    "EDIT_TEMPLATE" => "",	// Шаблон области по умолчанию
                    "PATH" => "/local/templates/landing/includes/common_f_b_t",	// Путь к файлу области
                ),
                    false
                );?>
                <?php $APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        "AREA_FILE_SUFFIX" => "inc",
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/local/templates/landing/includes/common_f_b_p",
            ...
            <div class="NB3_banner_form d-flex flex-column align-items-center justify-content-between NB_rounded-20">
                <script data-b24-form="inline/26/ydymm1" data-skip-moving="true">(function(w,d,u){var s=d.createElement('script');s.async=true;s.src=u+'?'+(Date.now()/180000|0);var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);})(window,document,'https://stage.citystaff.asgardd.tech/upload/crm/form/loader_26_ydymm1.js');</script>
            </div>
        </div>
    </section>
        ...
        <div class="NB3_info1_38 d-flex flex-row align-items-center justify-content-center">
            <?php $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/local/templates/landing/includes/common_b_f_HowWork_img"
                ),
                false
            );?>
        </div>
        <div class="NB3_info1_62 d-flex flex-column justify-content-center">
            <?php $APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/local/templates/landing/includes/common_b_f_HowWork_t"
                )
            );?>
            <?php $APPLICATION->IncludeComponent(
                "bitrix:main.include",
                ...
                array(
                    ...
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/local/templates/landing/includes/common_b_f_HowWork_t2"
                ),
                false
            );?>
	...
	array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => "/local/templates/landing/includes/common_b_f_HowWork_p"
	),
	false
);?>
            </div>
        ...
        <div class="NB3_info1_62 d-flex flex-column justify-content-center">
            <?php $APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/local/templates/landing/includes/common_f_greenb_h"
                )
            );?>
            <?php $APPLICATION->IncludeComponent(
                "bitrix:main.include",
                ...
                Array(
                    ...
                    "COMPONENT_TEMPLATE" => "main_about_p",
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/local/templates/landing/includes/common_f_greenb_p"
                )
            );?>
        </div>
        <div class="NB3_info1_38 d-flex flex-row align-items-center justify-content-center">
            <?php $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "COMPONENT_TEMPLATE" => ".default",
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/local/templates/landing/includes/common_f_greenb_img"
                ),
                false
            );?>
        </div>
            ...
            <div class="NB3_info1_38 d-flex flex-row align-items-center justify-content-between">
                <?php $APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "AREA_FILE_SUFFIX" => "inc",
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/local/templates/landing/includes/common_f_chat_img"
                    )
                );?>
            </div>
            <div class="NB3_info1_62 d-flex flex-column justify-content-center align-items-start">
                <?php $APPLICATION->IncludeComponent(
                    ...
                    Array(
                        ...
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/local/templates/landing/includes/common_f_chat_t"
                    )
                );?>
                <?php $APPLICATION->IncludeComponent(
                    "bitrix:main.include",
                    ...
                    Array(
                        ...
                        "COMPONENT_TEMPLATE" => "main_about_p",
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/local/templates/landing/includes/common_f_chat_p"
                    )
                );?>
                <?php $APPLICATION->IncludeComponent(
                    "bitrix:news.detail", "common_f_b_a", Array(
                    "ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
                    ...
                    "DISPLAY_PREVIEW_TEXT" => "Y",	// Выводить текст анонса
                    "DISPLAY_TOP_PAGER" => "N",	// Выводить над списком
                    "ELEMENT_CODE" => "link_faq",	// Код новости
    ...
    <section data-nav-title="График работ" id="workhours" class="d-flex flex-row justify-content-between NB3_WH widthBase NB_content">
        <?php $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "COMPONENT_TEMPLATE" => ".default",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/local/templates/landing/includes/common_f_WH_img"
            ),
            false
        );?>
        <div class="d-flex flex-column align-items-center justify-content-between NB3_WH_item NB_rounded-20">
            <?php $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "COMPONENT_TEMPLATE" => "main_community_item_title3",
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/local/templates/landing/includes/common_f_WH_h"
                ),
                false
            );?>
            <?php $APPLICATION->IncludeComponent(
