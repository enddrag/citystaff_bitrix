...
?>
	...
	false
        ...
        Array(
            ...
            "PAGER_TEMPLATE" => ".default",
            "PAGER_TITLE" => "Страница",
            "PROPERTY_CODE" => array(0=>"",1=>"a_link",),
            "SET_BROWSER_TITLE" => "N",
            "SET_CANONICAL_URL" => "N",
            "SET_LAST_MODIFIED" => "N",
            "SET_META_DESCRIPTION" => "Y",
                    ...
                    <div class="NB_about_content_title">
                         <?php $APPLICATION->IncludeComponent(
                            ...
                            Array(
                                ...
                                "EDIT_TEMPLATE" => "",
                                "PATH" => "/local/templates/landing/includes/main_about_title"
                            )
                        );?>
                         <?php $APPLICATION->IncludeComponent(
                            "bitrix:main.include",
                            ...
                            Array(
                                ...
                                "AREA_FILE_SUFFIX" => "inc",
                                "EDIT_TEMPLATE" => "",
                                "PATH" => "/local/templates/landing/includes/main_about_p"
                            )
                        );?>
                    </div>
    ...
    <section data-nav-title="Наши партнеры" id="partners" class="NB_content">
         <?php $APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/local/templates/landing/includes/main_clients_title"
            )
        );?>
         <?php $APPLICATION->IncludeComponent(
            "bitrix:news.list",
    ...
    <section data-nav-title="Что нас обьединяет?" id="union" class="NB_content">
        <?php $APPLICATION->IncludeComponent(
            ...
            "AREA_FILE_SHOW" => "file",	// Показывать включаемую область
                ...
                "PATH" => "/local/templates/landing/includes/main_union_title",	// Путь к файлу области
            ),
            false
        );?>
        <?php $APPLICATION->IncludeComponent(
    ...
    <section data-nav-title="Структура" id="struct" class="NB_content NB_content_department NB_rounded-20 widthBase d-flex flex-column align-items-center justify-content-center">
        <?php $APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/local/templates/landing/includes/main_structure_title"
            )
        );?>
        <?php $APPLICATION->IncludeComponent(
            "bitrix:main.include",
            ...
            Array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/local/templates/landing/includes/main_structure_minititle"
            )
        );?>
        <?php $APPLICATION->IncludeComponent(
            "bitrix:main.include",
            ...
            Array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/local/templates/landing/includes/main_structure_p"
            )
        );?>
        <?php $APPLICATION->IncludeComponent(
            "bitrix:main.include",
            ...
            Array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/local/templates/landing/includes/main_structure_button"
            )
        );?>
    ...
    <section data-nav-title="Наши традиции" id="tradition" class="NB_content NB_content_tradition widthBase d-flex flex-column">
        <?php $APPLICATION->IncludeComponent(
            ...
            Array(
                ...
                "EDIT_TEMPLATE" => "",
                "PATH" => "/local/templates/landing/includes/main_gallery_title"
            )
        );?>
        <?php $APPLICATION->IncludeComponent(
            "bitrix:main.include",
            ...
            Array(
                ...
                "EDIT_TEMPLATE" => "",
                "PATH" => "/local/templates/landing/includes/main_gallery_p"
            )
        );?>
        <?php $APPLICATION->IncludeComponent(
        ...
        <div class="NB_content_tradition_footer">
            <?php $APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "AREA_FILE_SUFFIX" => "inc",
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/local/templates/landing/includes/main_gallery_footer_p"
                )
            );?>
            <?php $APPLICATION->IncludeComponent(
                "bitrix:news.detail", "main_gallery_button", Array(
                "ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
                    ...
                    "ELEMENT_CODE" => "gallery_button",	// Код новости
    ...
    <section data-nav-title="Где и как мы общаемся" id="chats"  class="NB_content NB_content_community d-flex flex-column widthBase">
        <?php $APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/local/templates/landing/includes/main_community_title"
                )
            );?>
                ...
                <div class="NB_content_community_content_item_left NB_rounded-20 d-flex flex-column">
                     <?php $APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/landing/includes/main_community_item_title1"
                        )
                    );?>
                     <?php $APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/landing/includes/main_community_item_p1"
                        )
                    );?>
                     <?php $APPLICATION->IncludeComponent(
                        "bitrix:news.detail",
                     ...
                     <?php $APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/landing/includes/main_community_item_img1"
                        )
                    );?>
                </div>
                <div class="NB_content_community_content_item_left NB_rounded-20 d-flex flex-column">
                     <?php $APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/landing/includes/main_community_item_title2"
                        )
                    );?>
                     <?php $APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/landing/includes/main_community_item_p2"
                        )
                    );?>
                     <?php $APPLICATION->IncludeComponent(
                        "bitrix:news.detail",
                     ...
                     <?php $APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/landing/includes/main_community_item_img2"
                        )
                    );?>
                </div>
            </div>
                ...
                <div class="NB_content_community_content_item_right NB_rounded-20 d-flex flex-column">
                     <?php $APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/landing/includes/main_community_item_title3"
                        )
                    );?>
                     <?php $APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        ...
                        Array(
                            ...
                            "COMPONENT_TEMPLATE" => ".default",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/landing/includes/main_community_item_p3"
                        )
                    );?>
                     <?php $APPLICATION->IncludeComponent(
                        "bitrix:main.include",
                        ...
                        Array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/landing/includes/main_community_item_img3"
                        )
                    );?>
                </div>
            </div>
    ...
    <section data-nav-title="За нами интересно наблюдать" id="social"   class="NB_content d-flex flex-column widthBase">
        <?$APPLICATION->IncludeComponent(
                ...
                Array(
                        ...
                        "AREA_FILE_SUFFIX" => "inc",
                        "EDIT_TEMPLATE" => "",
                        "PATH" => "/local/templates/landing/includes/main_look_title"
                )
        );?>
        <?$APPLICATION->IncludeComponent(
                "bitrix:news.list",
                ...
                Array(
                        ...
                        "PARENT_SECTION_CODE" => "",
                        "PREVIEW_TRUNCATE_LEN" => "",
                        "PROPERTY_CODE" => array("link","link_text", "link_api"),
                        "SET_BROWSER_TITLE" => "Y",
                        "SET_LAST_MODIFIED" => "N",
                        "SET_META_DESCRIPTION" => "Y",
                        "SET_META_KEYWORDS" => "Y",
