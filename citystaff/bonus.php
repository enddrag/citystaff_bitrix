...
?>     <!--навигационное меню сайта-->
	...
	false
            ...
            <?php $APPLICATION->IncludeComponent("bitrix:news.list", "common_header_search", Array(
            ...
            <!--пункты навигации-->
            <?php $APPLICATION->IncludeComponent("bitrix:menu", "common_header_menu", Array(
        ...
        <div class="NB_right d-flex flex-row justify-content-around align-items-center">
            ...
            <?php $APPLICATION->IncludeComponent("bitrix:system.auth.form", "common_header_avatar", Array(
...
<!--баннер бонусов--> <section data-nav-title="Бонусы" id="bonus" class="widthBase NB2_banner d-flex flex-column justify-content-between">
...
<?$APPLICATION->IncludeComponent("bitrix:news.detail", "common_b_banner_footer", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
    ...
    <!--бонусы инфо--> <section class="widthBase NB_content NB1_section_info NB_content widthBase d-flex flex-row justify-content-between">
<div class="NB2_bonusInfo_left d-flex flex-column justify-content-between">
	<div class="NB2_bonusInfo_left_item d-flex flex-row justify-content-between">
		 <?$APPLICATION->IncludeComponent("bitrix:news.list", "common_b_info_white", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		"ADD_SECTIONS_CHAIN" => "Y",	// Включать раздел в цепочку навигации
		"AJAX_MODE" => "N",	// Включить режим AJAX
		"AJAX_OPTION_ADDITIONAL" => "",	// Дополнительный идентификатор
	...
	<div class="NB2_bonusInfo_left_item d-flex flex-row justify-content-between">
		<?$APPLICATION->IncludeComponent("bitrix:news.detail", "common_b_info_black", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		"ADD_ELEMENT_CHAIN" => "N",	// Включать название элемента в цепочку навигации
		"ADD_SECTIONS_CHAIN" => "Y",	// Включать раздел в цепочку навигации
		"AJAX_MODE" => "N",	// Включить режим AJAX
...
<?$APPLICATION->IncludeComponent(
  ...
  <!--стаффлики--> <section data-nav-title="Как заработать стаффлики?" id="staffcoinList" class="widthBase NB_content NB2_stafcoin d-flex flex-column">
<?$APPLICATION->IncludeComponent(
	"bitrix:main.include", 
	"main_community_item_title3", 
	array(
...
<!--модальное окно--> <section class="NB_modal d-flex flex-row align-items-center justify-content-center" id="modal1">
<div class="NB_modal_item d-flex">
 <img alt="X" src="img/X.svg" class="NB_modal_item_X" id="closeModal1">
</div>
 </section>

    <?$APPLICATION->IncludeComponent("bitrix:news.detail", "common_b_sport", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		"ADD_ELEMENT_CHAIN" => "N",	// Включать название элемента в цепочку навигации
		"ADD_SECTIONS_CHAIN" => "Y",	// Включать раздел в цепочку навигации
		"AJAX_MODE" => "N",	// Включить режим AJAX
    ...
    <!--здоровье--> <section class="widthBase NB_content NB2_health d-flex flex-column">
<?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	"main_community_item_title3",
	Array(
...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "common_b_h", Array(
	"COMPONENT_TEMPLATE" => ".default",
		"IBLOCK_TYPE" => "content",	// Тип информационного блока (используется только для проверки)
