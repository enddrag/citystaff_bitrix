...
?>
    ...
    <section data-nav-title="Ваше мнение важно" id="opinion" class="NB_banner d-flex flex-column align-items-center"
             style="background: linear-gradient(rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.37) 100%); background-size: cover; background-repeat: no-repeat; background-position-y: 20%">
        ...
        $APPLICATION->IncludeComponent(
            ...
            [
                ...
                'DISPLAY_PREVIEW_TEXT' => 'Y',
                'DISPLAY_TOP_PAGER' => 'N',
                'ELEMENT_CODE' => 'common_faq_banner_img',
                'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                'FIELD_CODE' => [
                    0 => '',
                    1 => '',
        ...
        <div class="NB3_info1_38 d-flex flex-row align-items-center justify-content-center">
            ...
            $APPLICATION->IncludeComponent(
                ...
                [
                    ...
                    'DISPLAY_PREVIEW_TEXT' => 'Y',
                    'DISPLAY_TOP_PAGER' => 'N',
                    'ELEMENT_CODE' => 'common_b_f_HowWork_img',
                    'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                    'FIELD_CODE' => [
                        0 => '',
                        1 => '',
        ...
        <div class="NB3_info1_62 d-flex flex-column justify-content-center">
            ...
            $APPLICATION->IncludeComponent(
                ...
                [
                    ...
                    'DISPLAY_PREVIEW_TEXT' => 'Y',
                    'DISPLAY_TOP_PAGER' => 'N',
                    'ELEMENT_CODE' => 'common_b_f_HowWork_t',
                    'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                    'FIELD_CODE' => [
                        0 => '',
                        1 => '',
            ...
            $APPLICATION->IncludeComponent(
                ...
                [
                    ...
                    'DISPLAY_PREVIEW_TEXT' => 'Y',
                    'DISPLAY_TOP_PAGER' => 'N',
                    'ELEMENT_CODE' => 'common_b_f_HowWork_t2',
                    'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                    'FIELD_CODE' => [
                        0 => '',
                        1 => '',
            ...
            <div class="Fbody d-flex flex-row align-items-center">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    [
                        ...
                        'DISPLAY_PREVIEW_TEXT' => 'Y',
                        'DISPLAY_TOP_PAGER' => 'N',
                        'ELEMENT_CODE' => 'common_b_f_HowWork_p',
                        'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                        'FIELD_CODE' => [
                            0 => '',
                            1 => '',
        ...
        <div class="NB3_info1_62 d-flex flex-column justify-content-center">
            ...
            $APPLICATION->IncludeComponent(
                ...
                [
                    ...
                    'DISPLAY_PREVIEW_TEXT' => 'Y',
                    'DISPLAY_TOP_PAGER' => 'N',
                    'ELEMENT_CODE' => 'common_f_greenb_h',
                    'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                    'FIELD_CODE' => [
                        0 => '',
                        1 => '',
            ...
            $APPLICATION->IncludeComponent(
                ...
                [
                    ...
                    'DISPLAY_PREVIEW_TEXT' => 'Y',
                    'DISPLAY_TOP_PAGER' => 'N',
                    'ELEMENT_CODE' => 'common_f_greenb_p',
                    'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                    'FIELD_CODE' => [
                        0 => '',
                        1 => '',
        ...
        <div class="NB3_info1_38 d-flex flex-row align-items-center justify-content-center">
            ...
            $APPLICATION->IncludeComponent(
                ...
                [
                    ...
                    'DISPLAY_PREVIEW_TEXT' => 'Y',
                    'DISPLAY_TOP_PAGER' => 'N',
                    'ELEMENT_CODE' => 'common_f_greenb_img',
                    'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                    'FIELD_CODE' => [
                        0 => '',
                        1 => '',
    ...
    <section data-nav-title="Чат с поддержкой" id="supportChats" class="widthBase NB_content">
        <div class="d-flex flex-row justify-content-between NB3_info3 NB_rounded-20">
            <div class="NB3_info1_38 d-flex flex-row align-items-center justify-content-between">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    [
                        ...
                        'DISPLAY_PREVIEW_TEXT' => 'Y',
                        'DISPLAY_TOP_PAGER' => 'N',
                        'ELEMENT_CODE' => 'common_f_chat_img',
                        'ELEMENT_ID' => $_REQUEST['ELEMENT_ID'],
                        'FIELD_CODE' => [
                            0 => '',
                            1 => '',
            ...
            <div class="NB3_info1_62 d-flex flex-column justify-content-center align-items-start">
                ...
                <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/supportarrow.svg" alt="" class="NB3_info1_arrow">
            </div>
        </div>
    </section>
    <!--график работ-->
